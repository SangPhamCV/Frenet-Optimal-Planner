...
class InteractivePlot:
    ...
    def publish_path(self):
        ...
        publish_waypoints.publish(path)  # Publish the entire path
...
if __name__ == "__main__":
    ...
    publish_waypoints = rospy.Publisher('/path', Path, queue_size=10)
    path_pub = rospy.Publisher('/points', Float32MultiArray, queue_size=10)
